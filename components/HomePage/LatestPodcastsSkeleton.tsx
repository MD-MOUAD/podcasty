    ...
    <div className="flex flex-col">
      {Array.from({ length: 4 }, (_, i) => {
        return (
          <div key={i}>
            <div className="flex">
              <div className="w-2/3 sm:w-1/2 flex items-center gap-6">
                {/* Podcast name and thumbnail */}
                <div className="w-2" />
                <div className="w-[52px] h-[54px] rounded-md bg-gray-400 animate-pulse" />
                <div className="h-2.5 w-28 lg:w-32 bg-gray-400 animate-pulse rounded-md" />
              </div>
              <div className="w-1/3 sm:w-1/2 flex items-center max-sm:justify-between">
                <div className="w-2/5">
                  {/* Podcast views */}
